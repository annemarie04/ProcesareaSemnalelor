...
plt.savefig('test_sah.png', format='png')
plt.show()
...
plt.axis('off')
plt.imshow(mat, cmap='gray')
plt.savefig('/test_sah_corect.png', format='png')
plt.show()
...
ax.set_ylim(1,20)
plt.axis('off')
plt.savefig('test_triunghi.png', format='png')
plt.show()
...
plt.axis('off')
plt.savefig('test_triunghi_corect.png', format='png')
plt.show()
...
ax.set_ylim(10,1)
plt.axis('off')
plt.savefig('test_linii.png', format='png')
plt.show()
...
plt.axis('off')
plt.savefig('test_linii_corect.png', format='png')
plt.show()
#%%
import numpy as np
import matplotlib.pyplot as plt
...
ax.set_ylim(15,90)
plt.axis('off')
plt.savefig('test_concav.png', format='png')
plt.show()
...
draw_lines(ax, compute_lines(pts))
plt.axis('off')
plt.savefig('test_concav_corect.png', format='png')
plt.show()
#%%
import numpy as np
import matplotlib.pyplot as plt
...
ax.set_ylim(5,70)
plt.axis('off')
plt.savefig('test_stea.png', format='png')
plt.show()
...
draw_lines(ax, compute_lines(pts))
plt.axis('off')
plt.savefig('test_stea_corect.png', format='png')
plt.show()
